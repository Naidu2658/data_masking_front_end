...
function Details() {
  ...
  <input type="text" id="schemaPath" name="schemaPath" value={sp} onChange={(e) => setsp(e.target.value)}/><br/>
  <label  htmlFor="datasetPath">DataSet Path:</label><br/>
  <input type="text" id="datasetPath" name="datasetPath" value={dp} onChange={(e) => setdp(e.target.value)}/><br/><br/>
  ...
  <input type="text" id="configurationName" name="configurationName" value={sp} onChange={(e) => setsp(e.target.value)}/><br/>
